...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.tabWidget_2.setGeometry(QtCore.QRect(250, 110, 831, 581))
        self.tabWidget_2.setObjectName("tabWidget_2")
        self.tab_3 = QtWidgets.QWidget()
        self.tab_3.setObjectName("tab_3")
        self.tableWidget_2 = QtWidgets.QTableWidget(self.tab_3)
        self.tableWidget_2.setGeometry(QtCore.QRect(10, 10, 811, 531))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.tableWidget_3.setGeometry(QtCore.QRect(10, 10, 811, 531))
        font = QtGui.QFont()
        font.setPointSize(10)
    ...
    def selectData(self):
        ...
        query_row_book = ("SELECT nama_buku FROM fact_peminjaman_bulan INNER JOIN dim_buku ON fact_peminjaman_bulan.`id_dimBuku`=dim_buku.`id` GROUP BY nama_buku")
