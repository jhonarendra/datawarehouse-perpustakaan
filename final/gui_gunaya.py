...
class Ui_MainWindow(object):
    ...
    def selectDataTahun(self):
        for i in range(0, 100):
            self.tableWidget_6.removeRow(0)
            self.tableWidget_6.removeColumn(0)
            self.tableWidget_7.removeRow(0)
            self.tableWidget_7.removeColumn(0)
        ...
        for y in range(len(row_name) + 1):
            self.tableWidget_6.insertRow(y)
            self.tableWidget_6.setVerticalHeaderLabels(array_row_name)
        ...
        for y in range(get_row_book):
            self.tableWidget_7.insertRow(y)
            self.tableWidget_7.setVerticalHeaderLabels(array_row_book)

        array_column = ['Januari', 'Februari', 'Maret', 'April', 'Mei', 'Juni', 'July', 'Agustus', 'September',
                        'Oktober', 'November', 'Desember', 'Total']
        for x in range(13):
            self.tableWidget_7.insertColumn(x)
            self.tableWidget_7.setHorizontalHeaderLabels(array_column)
            # self.tableWidget_3.horizontalHeader()
            self.tableWidget_6.insertColumn(x)
            self.tableWidget_6.setHorizontalHeaderLabels(array_column)
        ...
        for y, nama in enumerate(row_name):
            ...
            # print(arr_value)
            for i in range(0, 13):
                self.tableWidget_6.setItem(y, i, QtWidgets.QTableWidgetItem(str(arr_value[i])))
        ...
        print(total_data_nama)
        for x in range(13):
            self.tableWidget_6.setItem(len(row_name), x, QtWidgets.QTableWidgetItem(str(total_data_nama[x][1])))
        ...
        for y, buku in enumerate(row_book):
            ...
            for i in range(0, 13):
                self.tableWidget_7.setItem(y, i, QtWidgets.QTableWidgetItem(str(arr_value[i])))
        ...
        for x in range(13):
            self.tableWidget_7.setItem(get_row_book - 1, x, QtWidgets.QTableWidgetItem(str(total_data_buku[x][1])))
